...
export const GREGORIAN_HIGHLIGHTS: Highlight[] = [
  ...
  { id: 'labour',        name: 'International Labour Day', amharicName: 'ዓለም አቀፍ የሠራተኞች ቀን', calendar: 'gregorian', month: 5,  day: 1,  category: 'observance', tags: ['international', 'labour', 'public-holiday'] },
